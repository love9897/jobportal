...
{{-- notification modal --}}
<link rel="stylesheet" href="{{ asset('assets/css/notification_modal.css') }}">
...
<link rel="stylesheet" href="{{ asset('assets/css/inquery.css') }}">

{{-- bell-icon --}}
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
{{-- bell-icon-css --}}

<link rel="stylesheet" href="{{ asset('assets/css/bell_icon.css') }}">
