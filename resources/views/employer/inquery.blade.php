...
@section('content')
    {{-- <div class="section_our_solution">
        ...
        @if (count($inquery_details) > 0)
            <div class="row g-6">

                @foreach ($inquery_details as $details)
                    <div class="col-md-6">
                            ...
                            <div class="solution_cards_box">
                                <div class="solution_card">
                                    ...
                                    <div class="solu_description">
                                        ...
                                        <a href="{{ Storage::url('upload/cv/' . $details->resume) }}" class="read_more_btn"
                                            target="_blank">
                                            View Resume
                                            {{-- C:\laragon\www\laravel\app_job_portal\storage\app\public\cv --}}
    {{-- </a>
    </div>
    </div>
...
@else
    <img src="{{ asset('assets/img/no_result.gif') }}" alt="No inquery" class="rounded mx-auto d-block" width="400"
        height="300" style="">
    @endif --}}
    ...
    <div class="py-5">
        <div class="container">
                        ...
                        <div class="col-md-4">
                            <div class="card" style="padding: 10px">
                                <div class="card-block">
                                    <h4 class="card-title">{{ $details->name ?? $details->employee->name }}</h4>
                                    {{-- <h6 class="card-subtitle text-muted">{{ $details->name }}</h6> --}}
                                    <p class="card-text p-y-1">{{ $details->email ?? $details->employee->email }}</p>
                                    <p class="card-text p-y-1">{{ $details->phone ?? $details->employee->phone }}</p>

                                    <a href="{{ $details->employee != null ? Storage::url('upload/cv/' . $details->employee->empProfile->resume) : '' }}"
                                        target="_blank" class="card-link">View
                                        Resume </a>
                                </div>
                            </div>
                        </div>
            ...
            @else
                <img src="{{ asset('assets/img/no_result.gif') }}" alt="No inquery" class="rounded mx-auto d-block"
